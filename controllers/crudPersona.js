...
exports.update = (req, res) => {
    ...
    const comuna= req.body.txtComuna;
    const region=req.body.txtRegion
    result = conexion.query('UPDATE persona SET rut=$1, nombre=$2, apellido=$3, fechanacimiento=$4, correo=$5, direccion=$6,comuna_id=$7, region_id=$8 WHERE id=$9',[rut,nombre, apellido, fecha, correo,direccion,comuna,region,id], (error, result) => {
    console.log(result);
      if (error) {
        console.log(error);
      } else {
